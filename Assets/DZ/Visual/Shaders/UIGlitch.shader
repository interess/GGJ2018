   ...
   Properties
    {
        ...
        _OpacityProbability ("Opacity Glitch Probability", Float) = 0.022
        _OpacityIntensity ("Opacity Glitch Intensity", Float) = 0.09
        ...
        [MaterialToggle] _OpacityGlitchOn ("Opacity Glitch On", Float) = 1
        [MaterialToggle] _ColorGlitchOn ("Color Glitch On", Float) = 1
        [MaterialToggle] _IsFont ("Is Font", Float) = 0
    }
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            float _OpacityProbability;
            float _DispGlitchOn;
            float _OpacityGlitchOn;
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float opacityGlitchRandom = rand(timePositionVal, -timePositionVal);
                ...
                if(colorGlitchRandom < _ColorProbability && _ColorGlitchOn == 1) {
                    ...
                    c = normalC;
                    //c.rgb = tex2D(_MainTex, IN.texcoord.x, IN.texcoord.y);
                    // c.rgb = IN.color.rgb;
                    //c.rgb *= IN.color.a;
                }
                ...
                if (opacityGlitchRandom < _OpacityProbability && _OpacityGlitchOn == 1) {
                    c.a *= 1 - _OpacityIntensity * rand(0, 1);
                }
